...
/////////////////////////////////////////////////////////////////////////////////
// CIniWrapper Class Implementation
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
CIniWrapper::CIniWrapper()
{
	m_pszPathName = NULL;
}

CIniWrapper::CIniWrapper(LPCTSTR lpPathName)
{
	m_pszPathName = NULL;
...
void CIniWrapper::SetPathName(LPCTSTR lpPathName)
{
	if (lpPathName == NULL)
	{
		if (m_pszPathName != NULL)
...
DWORD CIniWrapper::GetPathName(LPTSTR lpBuffer, DWORD dwBufSize) const
{
	*lpBuffer = _T('\0');
	size_t dwLen = 0;
	if (lpBuffer != NULL)
...
#ifdef __AFXWIN_H__
CString CIniWrapper::GetPathName() const
{
...
// may be truncated.
DWORD CIniWrapper::GetString(LPCTSTR lpSection, LPCTSTR lpKey, LPTSTR lpBuffer, DWORD dwBufSize, LPCTSTR lpDefault) const
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');

	LPTSTR psz = __GetStringDynamic(lpSection, lpKey, lpDefault);
	size_t dwLen = _tcslen(psz);
...
void CIniWrapper::GetString(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpDefault, std::wstring& result) const
{
	LPTSTR psz = __GetStringDynamic(lpSection, lpKey, lpDefault);
  result = psz;
	delete [] psz;
...
#ifdef __AFXWIN_H__
CString CIniWrapper::GetString(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpDefault) const
{
	LPTSTR psz = __GetStringDynamic(lpSection, lpKey, lpDefault);
	CString str(psz);
	delete [] psz;
...
BOOL CIniWrapper::WriteString(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpValue) const
{
...
BOOL CIniWrapper::AppendString(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpString) const
{
	if (lpString == NULL)
		return FALSE;
...
DWORD CIniWrapper::GetArray(LPCTSTR lpSection, LPCTSTR lpKey, LPTSTR lpBuffer, DWORD dwBufSize, LPCTSTR lpDelimiter, BOOL bTrimString) const
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');
	...
	if (*psz != _T('\0'))
	{
		...
		{
			// just calculate the required buffer size
			const size_t MAX_LEN = _tcslen(psz) + 2;
			LPTSTR p = new TCHAR[MAX_LEN + 1];
			dwCopied = __StringSplit(psz, p, (DWORD)MAX_LEN, lpDelimiter, bTrimString);
			delete [] p;
		}
		else
		{
...
#ifdef __AFXWIN_H__
void CIniWrapper::GetArray(LPCTSTR lpSection, LPCTSTR lpKey, CStringArray *pArray, LPCTSTR lpDelimiter, BOOL bTrimString) const
{
	if (pArray != NULL)
		pArray->RemoveAll();
...
#ifdef __AFXWIN_H__
BOOL CIniWrapper::WriteArray(LPCTSTR lpSection, LPCTSTR lpKey, const CStringArray *pArray, int nWriteCount, LPCTSTR lpDelimiter) const
{
	if (pArray == NULL)
		return FALSE;
...
int CIniWrapper::GetInt(LPCTSTR lpSection, LPCTSTR lpKey, int nDefault, int nBase) const
{
...
UINT CIniWrapper::GetUInt(LPCTSTR lpSection, LPCTSTR lpKey, UINT nDefault, int nBase) const
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
...
__int64 CIniWrapper::GetInt64(LPCTSTR lpSection, LPCTSTR lpKey, __int64 nDefault, int nBase) const
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
	return *sz == _T('\0') ? nDefault : __int64(_tcstoi64(sz, NULL, __ValidateBase(nBase)));
}

// Get an unsigned 64 bit integer value
unsigned __int64  CIniWrapper::GetUInt64(LPCTSTR lpSection, LPCTSTR lpKey, unsigned __int64 nDefault, int nBase) const
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
	return *sz == _T('\0') ? nDefault : unsigned __int64(_tcstoui64(sz, NULL, __ValidateBase(nBase)));
}

// Get a boolean value
BOOL CIniWrapper::GetBool(LPCTSTR lpSection, LPCTSTR lpKey, BOOL bDefault) const
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
...
double CIniWrapper::GetDouble(LPCTSTR lpSection, LPCTSTR lpKey, double fDefault) const
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
...
BOOL CIniWrapper::WriteInt(LPCTSTR lpSection, LPCTSTR lpKey, int nValue, int nBase) const
{
...
BOOL CIniWrapper::WriteUInt(LPCTSTR lpSection, LPCTSTR lpKey, UINT nValue, int nBase) const
{
	TCHAR szValue[DEF_PROFILE_NUM_LEN + 1] = _T("");
...
BOOL CIniWrapper::WriteInt64(LPCTSTR lpSection, LPCTSTR lpKey, __int64 nValue, int nBase) const
{
	TCHAR szValue[DEF_PROFILE_NUM_LEN + 1] = _T("");
...
BOOL CIniWrapper::WriteUInt64(LPCTSTR lpSection, LPCTSTR lpKey, unsigned __int64 nValue, int nBase) const
{
	TCHAR szValue[DEF_PROFILE_NUM_LEN + 1] = _T("");
...
BOOL CIniWrapper::WriteDouble(LPCTSTR lpSection, LPCTSTR lpKey, double fValue, int nPrecision) const
{
	TCHAR szFmt[16] = _T("%f");
...
BOOL CIniWrapper::IncreaseDouble(LPCTSTR lpSection, LPCTSTR lpKey, double fIncrease, int nPrecision) const
{
...
BOOL CIniWrapper::WriteBool(LPCTSTR lpSection, LPCTSTR lpKey, BOOL bValue) const
{
...
// then write it back
BOOL CIniWrapper::InvertBool(LPCTSTR lpSection, LPCTSTR lpKey) const
{
...
BOOL CIniWrapper::IncreaseInt(LPCTSTR lpSection, LPCTSTR lpKey, int nIncrease, int nBase) const
{
...
BOOL CIniWrapper::IncreaseUInt(LPCTSTR lpSection, LPCTSTR lpKey, UINT nIncrease, int nBase) const
{
...
BOOL CIniWrapper::IncreaseInt64(LPCTSTR lpSection, LPCTSTR lpKey, int nIncrease, int nBase) const
{
...
BOOL CIniWrapper::IncreaseUInt64(LPCTSTR lpSection, LPCTSTR lpKey, int nIncrease, int nBase) const
{
	unsigned __int64 nVal = GetUInt64(lpSection, lpKey, 0, nBase);
	nVal += nIncrease;
	return WriteUInt64(lpSection, lpKey, nVal, nBase);
}

TCHAR CIniWrapper::GetChar(LPCTSTR lpSection, LPCTSTR lpKey, TCHAR cDefault) const
{
	TCHAR sz[2] = _T("");
...
BOOL CIniWrapper::WriteChar(LPCTSTR lpSection, LPCTSTR lpKey, TCHAR c) const
{
	TCHAR sz[2] = { c, _T('\0') };
...
DWORD CIniWrapper::GetDataBlock(LPCTSTR lpSection, LPCTSTR lpKey, LPVOID lpBuffer, DWORD dwBufSize, DWORD dwOffset) const
{
	LPTSTR psz = __GetStringDynamic(lpSection, lpKey);
	size_t dwLen = _tcslen(psz) / 2;
	if (dwLen <= dwOffset)
	{
		delete [] psz;
		return 0;
	...
	if (lpb != NULL)
	{
		dwProcLen = min((DWORD)dwLen - dwOffset, dwBufSize);
	...
	{
		dwProcLen = (DWORD) dwLen - dwOffset;
	}
	delete [] psz;
	return dwProcLen;
}
...
BOOL CIniWrapper::WriteDataBlock(LPCTSTR lpSection, LPCTSTR lpKey, LPCVOID lpData, DWORD dwDataSize) const
{
...
BOOL CIniWrapper::AppendDataBlock(LPCTSTR lpSection, LPCTSTR lpKey, LPCVOID lpData, DWORD dwDataSize) const
{
	const BYTE* lpb = (const BYTE*)lpData;
	if (lpb == NULL)
		return FALSE;
...
// Get a POINT value
POINT CIniWrapper::GetPoint(LPCTSTR lpSection, LPCTSTR lpKey, POINT ptDefault) const
{
	POINT pt;
...
// Get a RECT value
RECT CIniWrapper::GetRect(LPCTSTR lpSection, LPCTSTR lpKey, RECT rcDefault) const
{
	RECT rc;
...
BOOL CIniWrapper::WritePoint(LPCTSTR lpSection, LPCTSTR lpKey, POINT pt) const
{
	return WriteDataBlock(lpSection, lpKey, &pt, sizeof(POINT));
}

// Write a RECT to the ini file
BOOL CIniWrapper::WriteRect(LPCTSTR lpSection, LPCTSTR lpKey, RECT rc) const
{
...
DWORD CIniWrapper::GetKeyLines(LPCTSTR lpSection, LPTSTR lpBuffer, DWORD dwBufSize) const
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');
...
DWORD CIniWrapper::GetKeyNames(LPCTSTR lpSection, LPTSTR lpBuffer, DWORD dwBufSize) const
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');
...
DWORD CIniWrapper::GetSectionNames(LPTSTR lpBuffer, DWORD dwBufSize) const
{
	if (lpBuffer == NULL)
	{
		// just calculate the required buffer size
...
#ifdef __AFXWIN_H__
void CIniWrapper::GetSectionNames(CStringArray *pArray) const
{
	if (pArray != NULL)
		pArray->RemoveAll();
...
#ifdef __AFXWIN_H__
// Retrieve a list of key-lines(key-pairs) of the specified section
void CIniWrapper::GetKeyLines(LPCTSTR lpSection, CStringArray *pArray) const
{
	if (pArray != NULL)
		pArray->RemoveAll();
...
#ifdef __AFXWIN_H__
// Retrieve a list of key names of the specified section
void CIniWrapper::GetKeyNames(LPCTSTR lpSection, CStringArray *pArray) const
{
	if (pArray == NULL)
		return;
...
BOOL CIniWrapper::DeleteSection(LPCTSTR lpSection) const
{
	return ::WritePrivateProfileString(lpSection, NULL, _T(""), m_pszPathName);
}

// Remove a key from a section
BOOL CIniWrapper::DeleteKey(LPCTSTR lpSection, LPCTSTR lpKey) const
{
	return ::WritePrivateProfileString(lpSection, lpKey, NULL, m_pszPathName);
}

BOOL CIniWrapper::IsSectionExist(LPCTSTR lpSection) const
{
	if (lpSection == NULL)
		return FALSE;
...
BOOL CIniWrapper::IsKeyExist(LPCTSTR lpSection, LPCTSTR lpKey) const
{
	if (lpSection == NULL || lpKey == NULL)
		return FALSE;
...
BOOL CIniWrapper::CopySection(LPCTSTR lpSrcSection, LPCTSTR lpDestSection, BOOL bFailIfExist) const
{
...
BOOL CIniWrapper::CopyKey(LPCTSTR lpSrcSection, LPCTSTR lpSrcKey, LPCTSTR lpDestSection, LPCTSTR lpDestKey, BOOL bFailIfExist) const
{
...
BOOL CIniWrapper::MoveSection(LPCTSTR lpSrcSection, LPCTSTR lpDestSection, BOOL bFailIfExist) const
{
	return CopySection(lpSrcSection, lpDestSection, bFailIfExist)
		&& DeleteSection(lpSrcSection);
}

BOOL CIniWrapper::MoveKey(LPCTSTR lpSrcSection, LPCTSTR lpSrcKey, LPCTSTR lpDestSection, LPCTSTR lpDestKey, BOOL bFailIfExist) const
{
...
LPTSTR CIniWrapper::__GetStringDynamic(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpDefault) const
{
	TCHAR* psz = NULL;
	if (lpSection == NULL || lpKey == NULL)
	{
...
// of sub strings easily using user defined functions or CIniWrapper::ParseStringArray.
DWORD CIniWrapper::__StringSplit(LPCTSTR lpString, LPTSTR lpBuffer, DWORD dwBufSize, LPCTSTR lpDelimiter, BOOL bTrimString)
{
	...
	*lpBuffer = _T('\0');
	...
	const size_t DEL_LEN = _tcslen(pszDel);
	...
	while (lpEnd != NULL)
	{
		...
		const size_t SEG_LEN = _tcslen(pszSeg);
		const DWORD COPY_LEN = min((DWORD)SEG_LEN, dwBufSize - dwCopied);
...
// callback function
BOOL CIniWrapper::ParseDNTString(LPCTSTR lpString, SUBSTRPROC lpFnStrProc, LPVOID lpParam)
{
	if (lpString == NULL || lpFnStrProc == NULL)
		return FALSE;

	LPCTSTR p = lpString;
	size_t dwLen = _tcslen(p);
...
BOOL CALLBACK CIniWrapper::__SubStrCompare(LPCTSTR lpString1, LPVOID lpParam)
{
...
BOOL CALLBACK CIniWrapper:: __KeyPairProc(LPCTSTR lpString, LPVOID lpParam)
{
	int i;
  ...
  STR_LIMIT* psl = (STR_LIMIT*)lpParam;
	...
	// trim
	__TrimString(psz);
	size_t dwNameLen = _tcslen(psz);
	DWORD dwCopyLen = 0;
	
	//copy to the buffer
	if (psl->lpTarget != NULL)
	{
		dwCopyLen = (psl->dwRemain > 1) ? min((DWORD)dwNameLen, psl->dwRemain - 1) : 0;
...
BOOL CALLBACK CIniWrapper::__SubStrAdd(LPCTSTR lpString, LPVOID lpParam)
{
...
void CIniWrapper::__ToBinaryString(UINT nNumber, LPTSTR lpBuffer, DWORD dwBufSize)
{
	if (dwBufSize == 0)
		return;
...
// Convert an integer into binary string format
void CIniWrapper::__ToBinaryString(unsigned __int64 nNumber, LPTSTR lpBuffer, DWORD dwBufSize)
{
	if (dwBufSize == 0)
		return;
...
int CIniWrapper::__ValidateBase(int nBase)
{
	switch (nBase)
	{
	case BASE_BINARY:
...
void CIniWrapper::__IntToString(int nNumber, LPTSTR lpBuffer, int nBase)
{
	switch (nBase)
	{
	case BASE_BINARY:
...
void CIniWrapper::__UIntToString(UINT nNumber, LPTSTR lpBuffer, int nBase)
{
	switch (nBase)
	{
	case BASE_BINARY:
...
// Convert a signed integer into string representation, based on its base
void CIniWrapper::__Int64ToString( __int64 nNumber, LPTSTR lpBuffer, int nBase)
{
	switch (nBase)
	{
	case BASE_BINARY:
	case BASE_OCTAL:
	case BASE_HEXADECIMAL:
		__UInt64ToString((UINT)nNumber, lpBuffer, nBase);
		break;

	default:
		_stprintf(lpBuffer, _T("%dI64"), nNumber);
		break;
	}	
}

// Convert an unsigned integer into string representation, based on its base
void CIniWrapper::__UInt64ToString(unsigned __int64 nNumber, LPTSTR lpBuffer, int nBase)
{
	switch (nBase)
	{
	case BASE_BINARY:
...
BOOL CIniWrapper::StringToBool(LPCTSTR lpString, BOOL bDefault)
{
...
BOOL CIniWrapper::__TrimString(LPTSTR lpString)
{
	if (lpString == NULL)
		return FALSE;

	BOOL bTrimmed = FALSE;
	size_t nLen = _tcslen(lpString);
...
LPTSTR CIniWrapper::__StrDupEx(LPCTSTR lpStart, LPCTSTR lpEnd)
{
	const size_t LEN = (lpEnd - lpStart) / sizeof(TCHAR);
	LPTSTR psz = new TCHAR[LEN + 1];
...
/////////////////////////////////////////////////////////////////////////////////
// End of CIniWrapper Class Implementation
/////////////////////////////////////////////////////////////////////////////////
